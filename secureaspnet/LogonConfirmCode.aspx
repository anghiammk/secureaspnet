<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogonConfirmCode.aspx.cs" Inherits="secureaspnet.LogonConfirmCode" %>
...
<body>
    ...
    <div>
        <strong>Account Secret Key:</strong> <asp:Label runat="server" ID="lblSecretKey"></asp:Label>
        <hr />
